    ...
    <section id="layanan" className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">Solusi teknologi *end-to-end* yang disesuaikan dengan kebutuhan unik perusahaan Anda.</p>
        </motion.div>
          ...
          {servicesData.map((service, index) => {
            ...
            return (
              <motion.div
                ...
                whileHover={{ y: -10 }}
                className="bg-gray-50 p-8 rounded-2xl border border-gray-100 hover:shadow-2xl hover:shadow-blue-100 transition-all duration-300 group"
              >
